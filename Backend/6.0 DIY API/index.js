...
app.get("/jokes/:id", (req, res) => {
  const iduse = parseInt(req.params.id);
  const specificJoke = jokes.find((element) => element.id === iduse);
...
app.get("/filter", (req, res) => {
  ...
  const alljoketype = jokes.filter((element) => element.jokeType === joketypes);
  res.json(alljoketype);
});
